                ...
                <div>
                    ...
                    <p>
                        <ul>
                            ...
                            <li><a href="{{ route('smartcards.index') }}">Tarjetas</a></li>
                            ...
                            <hr>
                            <li><a href="{{ route('estadoempresas.index') }}">Estados de Empresas</a></li>
                            <li><a href="{{ route('estadovehiculos.index') }}">Estados de Vehiculos</a></li>
                            <li><a href="{{ route('tipovehiculos.index') }}">Tipos de Vehiculos</a></li>
                        </ul>
                    </p>
                </div>
            </div>
